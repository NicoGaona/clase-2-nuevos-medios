...
function portada() {
    createSpan(" Wena mi pana ¿Sabía usted que " + starWars.results[0].name + " tiene los ojitos de color " + starWars.results[0].eye_color + " y mide " + starWars.results[0].height + " cm?" + " además, su peso es " + starWars.results[0].mass + " kg?").parent("contenido");
